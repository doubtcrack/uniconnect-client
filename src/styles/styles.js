const styles = {
  ...
  productTitle: "text-[18px] font-[600] font-Roboto text-[#333]",
  ...
  shop_name: "pt-3 text-[15px] text-orange-700 pb-3",
  active_indicator: "absolute bottom-[-27%] left-0 h-[3px] w-full bg-[crimson]",
  button:
    "min-w-[150px] bg-gradient-to-r from-orange-800 to-rose-900 h-[50px] my-3 flex items-center justify-center rounded-xl cursor-pointer",
  cart_button:
